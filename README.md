...
**Project**: friendly-crud-creator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: lets create a CRUD application 
...
```sh
git clone https://github.com/GPT-Engineer-App/friendly-crud-creator.git
cd friendly-crud-creator
npm i
